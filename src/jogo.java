...
public class jogo {
	...
	static boolean jogar() throws InterruptedException {
		...
		switch (leia()) {
		case 1:
			escreva("Você acorda em sua cama, aparentemente, só mais um dia normal como os outros.", TimeUnit.MILLISECONDS, timer);
			creditos();
			return true;
		case 2:
		...
		escreva("Trinity: "+  nome + "lembra-se do que treinamos antes, seja (variável do tipo de treinamento escolhido pelo usuário)\n", TimeUnit.MILLISECONDS, timer);
		escreva("Jogando", TimeUnit.MILLISECONDS, timer);
